...
const Signup = (props) => {
  ...
  return (
    <div
      ref={loginRef}
      className={`absolute bg-white p-6 rounded-lg  max-sm:max-w-[85%] max-lg:max-w-[85%] max-h-screen overflow-y-auto  ${
    ...
    >
      ...
      {selectedOption === "Student" && studentNextModal === false && (
        <StudentSignup
          handleChaneIcon={handleChaneIcon}
      ...
      {selectedOption === "Instructor" && instructorFinalModal === true && (
        <FinalInstructor
          instructorSignup={instructorSignup}
          setInstructorSignup={setInstructorSignup}
          nextInstructorFinalPage={nextInstructorFinalPage}
