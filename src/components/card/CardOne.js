...
const CardOne = (props) => {
  return (
    <>
      <div className="flex     gap-7 items-center    bg-[red] max-lg:flex-wrap max-lg:flex ">
        {props?.dataOne?.map((item, ind) => {
          return (
            <>
              ...
              >
                <div className="mt-4 border-solid  w-full max-w-[260px] min-h-50  border border-gray-200 shadow-md rounded-lg">
                  <img
